...
```bash
bash .tessl/plugins/tessl-labs/good-oss-citizen/skills/recon/scripts/bash/github.sh templates-issue OWNER/REPO
```

**For a PR (run before drafting the PR description):**
```bash
bash .tessl/plugins/tessl-labs/good-oss-citizen/skills/recon/scripts/bash/github.sh templates-pr OWNER/REPO
```
